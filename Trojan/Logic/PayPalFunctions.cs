...
public class NVPAPICaller
{
    ...
    public string APIUsername = "nhoughto_api1.uvic.ca";
    private string APIPassword = "P85FSVSBCG37ECNZ";
    private string APISignature = "AedF1W8N1CG0-3G-5ZDNNEVIkTIHANcKSaQmwN-yRTaBZXYUpRpBqWxE";
